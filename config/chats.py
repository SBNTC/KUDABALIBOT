...
_STOP_PATTERNS: list[str] = [
    ...
    # Болтовня / реплики в обсуждениях
    r"^ну\s+или\b", r"^а\s+если\b",
    r"чат\s+гпт", r"chatgpt", r"\bgpt\b",
    r"ниразу\s+в\s+жизни", r"лучше\s+буду",
    r"никто\s+тут", r"можно\s+на\s+редите",
    r"печать\s+такая\s+же", r"все\s+симки",
    # Барахолка / купля-продажа
    r"в\s+продаже\b", r"в\s+наличии\b",
    r"битых\s+пикселей", r"идеальн\w+\s+состояни",
    r"пишите\s+в\s+лс", r"пишите\s+в\s+дм",
]
